# 올리브영 영양제 시장 데이터 분석 및 비즈니스 액션 플랜
...
## 1. 초기 데이터 점검 및 기초 통계
*   **전체 상품 수**: 947개
*   **수집 변수 수**: 5개 (`brand`, `name`, `original_price`, `discount_price`, `url` 등)
*   **중복 데이터 수**: 0건 (결측치 제외 전 정제됨)

### 수치형 변수 기술 통계
|       |   original_price |   discount_price |   discount_rate |
|:------|-----------------:|-----------------:|----------------:|
| count |            947   |            947   |       947       |
| mean  |          32934.8 |          30147.6 |         8.89102 |
| std   |          25506.3 |          24963.8 |        12.6637  |
| min   |           2500   |           1750   |         0       |
| 25%   |          18500   |          16600   |         0       |
| 50%   |          27900   |          24600   |         3.8     |
| 75%   |          39500   |          36000   |        13.4     |
| max   |         276000   |         267720   |        72.5     |
...
올리브영 영양제 상품의 정가(original_price), 할인가(discount_price), 그리고 할인율(discount_rate) 통계를 분석한 결과 다음과 같은 특징이 두드러집니다.
...
올리브영 영양제 데이터 중 범주형 변수인 브랜드(brand)와 가격 세그먼트(price_segment)를 교차 분석한 결과는 유통 플랫폼으로서의 올리브영의 입지와 상품 기획 방향성을 정밀하게 드러냅니다.
